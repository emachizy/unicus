    ...
    <>
      ...
      >
        <AccordionHeader
          ...
          className={`border-b-0 transition-colors text-white duration-500${
            open === 1 ? "text-blue-500 hover:!text-blue-700" : ""
          }`}
        >
          What is Material Tailwind?
        </AccordionHeader>
        <AccordionBody className="pt-0 text-base font-normal text-white transition-all duration-700">
